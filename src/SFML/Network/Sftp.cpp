...
sf::Sftp::Result makeSftpError(LIBSSH2_SFTP* sftp)
{
    ...
    if (!sftp)
        return sf::Sftp::Result(Value::Error, "General error");

    switch (libssh2_sftp_last_error(sftp))
    {
        case LIBSSH2_FX_EOF:
            return sf::Sftp::Result(Value::EndOfFile, "End of file");
        case LIBSSH2_FX_NO_SUCH_FILE:
            return sf::Sftp::Result(Value::NoSuchFile, "No such file");
        case LIBSSH2_FX_PERMISSION_DENIED:
            return sf::Sftp::Result(Value::PermissionDenied, "Permission denied");
        case LIBSSH2_FX_FAILURE:
            return sf::Sftp::Result(Value::Failure, "Failure");
        case LIBSSH2_FX_BAD_MESSAGE:
            return sf::Sftp::Result(Value::BadMessage, "Bad message");
        case LIBSSH2_FX_NO_CONNECTION:
            return sf::Sftp::Result(Value::NoConnection, "No connection");
        case LIBSSH2_FX_CONNECTION_LOST:
            return sf::Sftp::Result(Value::ConnectionLost, "Connection lost");
        case LIBSSH2_FX_OP_UNSUPPORTED:
            return sf::Sftp::Result(Value::OperationUnsupported, "Operation unsupported");
        case LIBSSH2_FX_INVALID_HANDLE:
            return sf::Sftp::Result(Value::InvalidHandle, "Invalid handle");
        case LIBSSH2_FX_NO_SUCH_PATH:
            return sf::Sftp::Result(Value::NoSuchPath, "No such path");
        case LIBSSH2_FX_FILE_ALREADY_EXISTS:
            return sf::Sftp::Result(Value::FileAlreadyExists, "File already exists");
        case LIBSSH2_FX_WRITE_PROTECT:
            return sf::Sftp::Result(Value::WriteProtect, "Write protect");
        case LIBSSH2_FX_NO_MEDIA:
            return sf::Sftp::Result(Value::NoMedia, "No media");
        case LIBSSH2_FX_NO_SPACE_ON_FILESYSTEM:
            return sf::Sftp::Result(Value::NoSpaceOnFileSystem, "No space on filesystem");
        case LIBSSH2_FX_QUOTA_EXCEEDED:
            return sf::Sftp::Result(Value::QuotaExceeded, "Quota exceeded");
        case LIBSSH2_FX_UNKNOWN_PRINCIPAL:
            return sf::Sftp::Result(Value::UnknownPrincipal, "Unknown principal");
        case LIBSSH2_FX_LOCK_CONFLICT:
            return sf::Sftp::Result(Value::LockConflict, "Lock conflict");
        case LIBSSH2_FX_DIR_NOT_EMPTY:
            return sf::Sftp::Result(Value::DirectoryNotEmpty, "Directory not empty");
        case LIBSSH2_FX_NOT_A_DIRECTORY:
            return sf::Sftp::Result(Value::NotADirectory, "Not a directory");
        case LIBSSH2_FX_INVALID_FILENAME:
            return sf::Sftp::Result(Value::InvalidFilename, "Invalid filename");
        case LIBSSH2_FX_LINK_LOOP:
            return sf::Sftp::Result(Value::LinkLoop, "Link loop");
        default:
...
sf::Sftp::Result makeError(LIBSSH2_SESSION* session, LIBSSH2_SFTP* sftp = nullptr)
{
    ...
    switch (error)
    {
        case LIBSSH2_ERROR_BANNER_RECV:
            return sf::Sftp::Result(Value::BannerReceive, {ptr, size});
        case LIBSSH2_ERROR_BANNER_SEND:
            return sf::Sftp::Result(Value::BannerSend, {ptr, size});
        case LIBSSH2_ERROR_INVALID_MAC:
            return sf::Sftp::Result(Value::InvalidMac, {ptr, size});
        case LIBSSH2_ERROR_KEX_FAILURE:
            return sf::Sftp::Result(Value::KeyExchangeFailure, {ptr, size});
        case LIBSSH2_ERROR_ALLOC:
            return sf::Sftp::Result(Value::AllocationFailure, {ptr, size});
        case LIBSSH2_ERROR_SOCKET_SEND:
            return sf::Sftp::Result(Value::SocketSend, {ptr, size});
        case LIBSSH2_ERROR_KEY_EXCHANGE_FAILURE:
            return sf::Sftp::Result(Value::KeyExchangeFailure, {ptr, size});
        case LIBSSH2_ERROR_TIMEOUT:
            return sf::Sftp::Result(Value::Timeout, {ptr, size});
        case LIBSSH2_ERROR_HOSTKEY_INIT:
            return sf::Sftp::Result(Value::HostKeyInitialization, {ptr, size});
        case LIBSSH2_ERROR_HOSTKEY_SIGN:
            return sf::Sftp::Result(Value::HostKeySign, {ptr, size});
        case LIBSSH2_ERROR_DECRYPT:
            return sf::Sftp::Result(Value::DecryptError, {ptr, size});
        case LIBSSH2_ERROR_SOCKET_DISCONNECT:
            return sf::Sftp::Result(Value::Disconnected, {ptr, size});
        case LIBSSH2_ERROR_PROTO:
            return sf::Sftp::Result(Value::ProtocolError, {ptr, size});
        case LIBSSH2_ERROR_PASSWORD_EXPIRED:
            return sf::Sftp::Result(Value::PasswordExpired, {ptr, size});
        case LIBSSH2_ERROR_FILE:
            return sf::Sftp::Result(Value::FileError, {ptr, size});
        case LIBSSH2_ERROR_METHOD_NONE:
            return sf::Sftp::Result(Value::MethodNone, {ptr, size});
        case LIBSSH2_ERROR_AUTHENTICATION_FAILED:
            return sf::Sftp::Result(Value::AuthenticationFailed, {ptr, size});
        case LIBSSH2_ERROR_PUBLICKEY_UNVERIFIED:
            return sf::Sftp::Result(Value::PublicKeyUnverified, {ptr, size});
        case LIBSSH2_ERROR_CHANNEL_OUTOFORDER:
            return sf::Sftp::Result(Value::ChannelOutOfOrder, {ptr, size});
        case LIBSSH2_ERROR_CHANNEL_FAILURE:
            return sf::Sftp::Result(Value::ChannelFailure, {ptr, size});
        case LIBSSH2_ERROR_CHANNEL_REQUEST_DENIED:
            return sf::Sftp::Result(Value::ChannelRequestDenied, {ptr, size});
        case LIBSSH2_ERROR_CHANNEL_UNKNOWN:
            return sf::Sftp::Result(Value::ChannelUnknown, {ptr, size});
        case LIBSSH2_ERROR_CHANNEL_WINDOW_EXCEEDED:
            return sf::Sftp::Result(Value::ChannelWindowExceeded, {ptr, size});
        case LIBSSH2_ERROR_CHANNEL_PACKET_EXCEEDED:
            return sf::Sftp::Result(Value::ChannelPacketExceeded, {ptr, size});
        case LIBSSH2_ERROR_CHANNEL_CLOSED:
            return sf::Sftp::Result(Value::ChannelClosed, {ptr, size});
        case LIBSSH2_ERROR_CHANNEL_EOF_SENT:
            return sf::Sftp::Result(Value::ChannelEofSent, {ptr, size});
        case LIBSSH2_ERROR_SCP_PROTOCOL:
            return sf::Sftp::Result(Value::ScpProtocol, {ptr, size});
        case LIBSSH2_ERROR_ZLIB:
            return sf::Sftp::Result(Value::ZlibError, {ptr, size});
        case LIBSSH2_ERROR_SOCKET_TIMEOUT:
            return sf::Sftp::Result(Value::Timeout, {ptr, size});
        case LIBSSH2_ERROR_SFTP_PROTOCOL:
            return makeSftpError(sftp);
        case LIBSSH2_ERROR_REQUEST_DENIED:
            return sf::Sftp::Result(Value::RequestDenied, {ptr, size});
        case LIBSSH2_ERROR_METHOD_NOT_SUPPORTED:
            return sf::Sftp::Result(Value::MethodNotSupported, {ptr, size});
        case LIBSSH2_ERROR_INVAL:
            return sf::Sftp::Result(Value::InvalidData, {ptr, size});
        case LIBSSH2_ERROR_PUBLICKEY_PROTOCOL:
            return sf::Sftp::Result(Value::PublicKeyProtocol, {ptr, size});
        case LIBSSH2_ERROR_BUFFER_TOO_SMALL:
            return sf::Sftp::Result(Value::BufferTooSmall, {ptr, size});
        case LIBSSH2_ERROR_BAD_USE:
            return sf::Sftp::Result(Value::BadUse, {ptr, size});
        case LIBSSH2_ERROR_COMPRESS:
            return sf::Sftp::Result(Value::CompressError, {ptr, size});
        case LIBSSH2_ERROR_OUT_OF_BOUNDARY:
            return sf::Sftp::Result(Value::OutOfBoundary, {ptr, size});
        case LIBSSH2_ERROR_AGENT_PROTOCOL:
            return sf::Sftp::Result(Value::AgentProtocol, {ptr, size});
        case LIBSSH2_ERROR_SOCKET_RECV:
            return sf::Sftp::Result(Value::SocketRecv, {ptr, size});
        case LIBSSH2_ERROR_ENCRYPT:
            return sf::Sftp::Result(Value::EncryptError, {ptr, size});
        case LIBSSH2_ERROR_BAD_SOCKET:
            return sf::Sftp::Result(Value::BadSocket, {ptr, size});
        case LIBSSH2_ERROR_KNOWN_HOSTS:
            return sf::Sftp::Result(Value::KnownHosts, {ptr, size});
        case LIBSSH2_ERROR_CHANNEL_WINDOW_FULL:
            return sf::Sftp::Result(Value::ChannelWindowFull, {ptr, size});
        case LIBSSH2_ERROR_KEYFILE_AUTH_FAILED:
            return sf::Sftp::Result(Value::KeyFileAuthenticationFailed, {ptr, size});
        default:
...
namespace sf
{
struct Sftp::Impl : LibSsh2Initializer
{
    Impl()
    {
    ...
    int waitForOperationComplete(const Callable& operation, const sf::TimeoutWithPredicate& timeout)
    {
        while (true)
        {
    ...
    Sftp::Result initializeSftp(const TimeoutWithPredicate& timeout)
    {
        const auto result = waitForOperationComplete(
            [&]
            {
                sftpSession.reset(libssh2_sftp_init(ssh2Session.get()));

                if (sftpSession)
                    return LIBSSH2_ERROR_NONE;

                return libssh2_session_last_errno(ssh2Session.get());
            },
            timeout);
        ...
        if (result < 0)
            return makeError(ssh2Session.get());
    ...
    std::filesystem::path                                cachedHomePath;
    TcpSocket                                            socket;
...
////////////////////////////////////////////////////////////
Sftp::Result Sftp::connect(IpAddress server, unsigned short port, const TimeoutWithPredicate& timeout)
{
    ...
    m_impl->selectorRecv.add(m_impl->socket, sf::SocketSelector::Receive);
    m_impl->selectorSend.add(m_impl->socket, sf::SocketSelector::Send);
    m_impl->selectorEither.add(m_impl->socket, sf::SocketSelector::Receive | sf::SocketSelector::Send);
...
////////////////////////////////////////////////////////////
Sftp::Result Sftp::disconnect(const TimeoutWithPredicate& timeout)
{
    // Clear the cached home path
    m_impl->cachedHomePath.clear();
...
std::optional<Sftp::SessionInfo> Sftp::getSessionInfo() const
{
    ...
    const auto getSessionMethod = [session = m_impl->ssh2Session.get()](int method) -> std::string
    {
        ...
        if (const auto* const result = libssh2_session_methods(session, method); result)
            return result;
        err() << "SFTP: Cannot get session information, session not yet started" << std::endl;
        return "";
    };
...
Sftp::Result Sftp::login(std::string_view name, std::string_view password, const TimeoutWithPredicate& timeout)
{
    ...
    return m_impl->initializeSftp(timeout);
}


////////////////////////////////////////////////////////////
Sftp::Result Sftp::login(std::string_view            name,
...
Sftp::Result Sftp::login(std::string_view            name,
                         ...
                         const TimeoutWithPredicate& timeout)
{
    // Ensure the passphrase is NULL-terminated
    const std::string privateKeyPassphraseString(privateKeyPassphrase);
    return login(name,
                 publicKeyData.data(),
                 publicKeyData.length(),
                 privateKeyData.data(),
                 privateKeyData.length(),
                 privateKeyPassphraseString.c_str(),
                 timeout);
}
...
////////////////////////////////////////////////////////////
Sftp::PathResult Sftp::getWorkingDirectory(const TimeoutWithPredicate& timeout)
{
